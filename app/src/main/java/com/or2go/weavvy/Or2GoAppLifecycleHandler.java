...
public class Or2GoAppLifecycleHandler implements ComponentCallbacks2, Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityDestroyed(@NonNull Activity activity) {
        if (activity.getLocalClassName().compareTo("genipos.customer.UserRegistrationActivity") == 0) {
            if (!gAppEnv.gAppSettings.getUserId().isEmpty())
                gAppEnv.startBackgroundMessageCheck();
        }
    }
}
